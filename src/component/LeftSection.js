      ...
      <Stack spacing={-3} className="headings">
        ...
        <item className="item2">
          <Typography
            ...
            fontSize={30}
          >
            Information for Excellence in Research
          </Typography>
        </item>
        <item className="item3">
          <Typography
            ...
            my={3}
          >
            Focused On Unique Needs Of The<br></br>
            Research Community
          </Typography>
        </item>
      </Stack>
      <Box className="middle-container" mt={-2}>
        <Grid container className="grid-container">
          <Grid item sm={"5"} md={"4"} className="four-columns" padding={2}>
            <Grid sm="12">
              <Typography variant="h6" fontSize={25} fontWeight="bold" my={-1}>
                NIH NEWS
              </Typography>
            </Grid>
            <Grid sx={{ position: "relative" }} padding={0}>
              <Box sx={{ position: "relative" }}>
                ...
                >
                  Brain signatures of chronic pain<br></br>
                  identified in a small group of people<br></br>
                  <b>May 25. 2023</b>
                </Typography>
              </Box>
            </Grid>
            <Grid sx={{ position: "relative" }} paddingBottom={0}>
              <Box sx={{ position: "relative" }}>
                <img
                  style={{ width: "100%" }}
                  src={Doctors}
                ...
                <Typography
                  variant="caption"
                  fontSize={"10px"}
                  sx={{ position: "absolute", display: "block", top: "60%" }}
                >
                  Mirati’s Sitravatnib Fails in Phase III<br></br>Lung Cancer
                  Trial,Nixes Development<br></br>
                  <b>May 25. 2023</b>
                </Typography>
              </Box>
            </Grid>
          ...
          <Grid item sm="7" md="8" className="eight-columns">
            ...
            <Grid container paddingLeft={2}>
              ...
              <Grid item md="11">
                <Typography variant="caption" fontSize={10}>
                  <b>
                    Impact of Vaccines; Health, Economic & Social Perspectives
                  </b>
                  <br></br>
            ...
            <Grid
              container
              paddingLeft={2}
              borderBottom={"2px solid  #FFFFFF97"}
            >
              <Grid item md="1">
                <img src={Book} alt="skull-img"></img>
              </Grid>
              <Grid item md="11" paddingBottom={1}>
                <Typography variant="caption" fontSize={10}>
                  <b>
                    Detoxification of azo dyes in the context of environmental
                    processes
                  </b>
                  <br></br>
            ...
            <Grid container>
              ...
              >
                ...
                <Box sx={{ position: "relative" }}>
                  ...
                  >
                    First-in-human trial of oral drug to<br></br> remove
                ...
                <Box sx={{ position: "relative" }}>
                  ...
                  >
                    Scientists release a new human<br></br> “pangenome”
                    reference
                  </Typography>
                </Box>
              </Grid>
              ...
              >
                ...
                <Box sx={{ position: "relative" }}>
                  ...
                  >
                    Obstructive sleep apnea associated with<br></br> increased
                ...
                <Box sx={{ position: "relative" }}>
                  ...
                  >
                    Therapy for Rare Bone Disorder<br></br>Shows Promise in NIH
                    Clinical Trial
                  </Typography>
                </Box>
              </Grid>
